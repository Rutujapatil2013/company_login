...
public class CompanyController {
    ...
    //get company id by using company names
    @GetMapping("/company/{companyName}")
    public Long getCompanyIdByCompanyName(@PathVariable String companyName) throws Exception {
        return (companyService.getCompanyIdByCompanyName(companyName));
    }
